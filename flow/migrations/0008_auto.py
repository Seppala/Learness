...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'flow.project': {
            ...
            'appliers': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'appliers'", 'blank': 'True', 'to': "orm['auth.User']"}),
            'collaborators': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'collaborators'", 'blank': 'True', 'to': "orm['auth.User']"}),
