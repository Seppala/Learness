...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding ManyToManyField 'Project.appliers'
    ...
    def backwards(self, orm):
        ...
        # Dropping ManyToManyField 'Project.appliers'
    ...
    models = {
        ...
        'flow.project': {
            'appliers': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['auth.User']", 'null': 'True'}),
