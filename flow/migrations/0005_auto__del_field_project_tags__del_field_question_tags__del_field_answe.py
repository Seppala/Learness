...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('flow_project', 'tags')
        ...
        db.delete_column('flow_question', 'tags')

        # Deleting field 'answer.tags'
        db.delete_column('flow_answer', 'tags')


    def backwards(self, orm):
        
        # Adding field 'project.tags'
        db.add_column('flow_project', 'tags', self.gf('tagging.fields.TagField')(default=1), keep_default=False)
        ...
        db.add_column('flow_question', 'tags', self.gf('tagging.fields.TagField')(default=1), keep_default=False)

        # Adding field 'answer.tags'
        db.add_column('flow_answer', 'tags', self.gf('tagging.fields.TagField')(default=1), keep_default=False)
