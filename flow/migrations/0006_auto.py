...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'flow.project': {
            ...
            'appliers': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'appliers'", 'null': 'True', 'to': "orm['auth.User']"}),
            'collaborators': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'collaborators'", 'null': 'True', 'to': "orm['auth.User']"}),
