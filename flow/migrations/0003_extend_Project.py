...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.datecreated'
        db.add_column('flow_project', 'datecreated', orm['flow.project:datecreated'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Project.datecreated'
        db.delete_column('flow_project', 'datecreated')
